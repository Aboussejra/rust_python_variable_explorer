...
console.log(`Installing and compiling rust_python_variable_explorer 0.1.0 ${features} ...`);
exec(`cargo install rust_python_variable_explorer --vers 0.1.0 ${features}`, (error, stdout, stderr) => {
  console.log(stdout);
  if (error || stderr) {
