...
const binp = path.join(cargoDir, "bin", "rust_python_variable_explorer");

if (fs.existsSync(binp)) {
  console.log("Uninstalling rust_python_variable_explorer...");
  exec(`cargo uninstall rust_python_variable_explorer`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("rust_python_variable_explorer not found skipping!");
}
